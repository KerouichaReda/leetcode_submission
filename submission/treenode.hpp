...
TreeNode* createTreeNodeFromArrayUtil(std::vector<int>& array, int index,
                                      const int end);
TreeNode* createTreeNodeFromArray(std::vector<int>& array);
TreeNode* createTreeNodeFromArrayUtil(std::queue<int>& nodesLeft,
                                      const int vnull);
...
TreeNode* createTreeNodeFromSortedArrayUtil(std::vector<int>& array, int start,
    ...
    tempTreeNode->right =
        createTreeNodeFromSortedArrayUtil(array, mid + 1, end);
    return tempTreeNode;
}
...
TreeNode* createTreeNodeFromArrayUtil(std::vector<int>& array, int index,
    ...
    tempTreeNode->right =
        createTreeNodeFromArrayUtil(array, 2 * index + 2, end);
    return tempTreeNode;
}

TreeNode* createTreeNodeFromArray(std::vector<int>& array) {
    int index = 0;
    return createTreeNodeFromArrayUtil(array, index,
